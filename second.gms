...
PARAMETERS
    t_arr(I)    'arrival time of puck I'
     ...
     t_dep(J)   'departing time of puck J'
      ...
      walk_cost(K,K)  'cost of walking between gates'
      /K1 .K2 20,   K1 .K3 10
                    K2. K3 30/

      no_conn_pass(I,J) 'number of connecting passengers between flight I and flight J'
      /I3 .J5 10/;
...
EQUATIONS
    ...
    unconvenienceCostEq         .. unconvenienceCost =e= 0;
